...
This is an end-to-end Generative AI app that analyzes a candidate’s CV against a target job role, identifies skill gaps, and generates personalized learning insights. This app is trained on this repo and other sources. [Try App NOW!](https://skill-gap-analyzer-ai.streamlit.app/)
